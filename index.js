...
AquaDemon.get("/", (req, res) => {
  res.send("AquaDemon Development");
});
...
const { parseFiles, parseExtraOptions } = require("aoi.parser/components");
...
// This project is coded and licensed by AquaDemon